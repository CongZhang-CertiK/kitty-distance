...
fileLevelConstant
  : typeName (InternalKeyword | PrivateKeyword | PublicKeyword)? ConstantKeyword identifier '=' expression ';';
...
identifier
  : ('from' | 'calldata' | 'receive' | 'callback' | 'revert' | 'error' | 'address' | ConstructorKeyword | PayableKeyword | LeaveKeyword | GlobalKeyword | Identifier);
